...
REPOS: list[dict[str, Any]] = [
    ...
    {
        "path": "/Users/owner/code/atlas-cli",
        "health": "critical",
        "floorScore": None,
        "mcpActive": False,
    },
...
EXAM_DETAIL: dict[str, dict[str, Any]] = {
    "exam-0058": {
        ...
        "attempts": [
            {"n": 1, "tokens": 118_400, "mode": "harness-debug", "verdict": "fail", "ungradedCode": None, "grades": [{"name": "correctness", "score": 0.31, "max": 1.0}, {"name": "integration", "score": 0.22, "max": 1.0}, {"name": "conventions", "score": 0.55, "max": 1.0}, {"name": "evidence", "score": 0.18, "max": 1.0}, {"name": "restraint", "score": 0.40, "max": 1.0}], "axes": [{"name": "correctness", "score": 0.31, "max": 1.0}, {"name": "integration", "score": 0.22, "max": 1.0}, {"name": "conventions", "score": 0.55, "max": 1.0}, {"name": "evidence", "score": 0.18, "max": 1.0}, {"name": "restraint", "score": 0.40, "max": 1.0}]},
            {"n": 2, "tokens": 142_900, "mode": "harness-debug", "verdict": "fail", "ungradedCode": None, "grades": [{"name": "correctness", "score": 0.38, "max": 1.0}, {"name": "integration", "score": 0.30, "max": 1.0}, {"name": "conventions", "score": 0.60, "max": 1.0}, {"name": "evidence", "score": 0.25, "max": 1.0}, {"name": "restraint", "score": 0.48, "max": 1.0}], "axes": [{"name": "correctness", "score": 0.38, "max": 1.0}, {"name": "integration", "score": 0.30, "max": 1.0}, {"name": "conventions", "score": 0.60, "max": 1.0}, {"name": "evidence", "score": 0.25, "max": 1.0}, {"name": "restraint", "score": 0.48, "max": 1.0}]},
            {"n": 3, "tokens": 166_100, "mode": "experiment", "verdict": "partial", "ungradedCode": None, "grades": [{"name": "correctness", "score": 0.44, "max": 1.0}, {"name": "integration", "score": 0.35, "max": 1.0}, {"name": "conventions", "score": 0.66, "max": 1.0}, {"name": "evidence", "score": 0.31, "max": 1.0}, {"name": "restraint", "score": 0.52, "max": 1.0}], "axes": [{"name": "correctness", "score": 0.44, "max": 1.0}, {"name": "integration", "score": 0.35, "max": 1.0}, {"name": "conventions", "score": 0.66, "max": 1.0}, {"name": "evidence", "score": 0.31, "max": 1.0}, {"name": "restraint", "score": 0.52, "max": 1.0}]},
            # DELIBERATELY OUT OF CONTRACT. `mode` is evaluation | experiment |
            # harness-debug and the ledger enforces it, so "sideways" cannot
            # reach a real client. It is here to exercise the branch that shows
            # an unrecognised mode VERBATIM rather than quietly mapping it to a
            # known one, which is the behaviour that keeps a client honest if
            # the vocabulary ever grows ahead of it. Anyone counting documented
            # modes must exclude this row; the vocabulary test does.
            {"n": 4, "tokens": 201_800, "mode": "sideways", "verdict": "unsubmitted", "ungradedCode": None, "grades": [{"name": "correctness", "score": 0.51, "max": 1.0}, {"name": "integration", "score": 0.41, "max": 1.0}, {"name": "conventions", "score": 0.71, "max": 1.0}, {"name": "evidence", "score": 0.36, "max": 1.0}, {"name": "restraint", "score": 0.59, "max": 1.0}], "axes": [{"name": "correctness", "score": 0.51, "max": 1.0}, {"name": "integration", "score": 0.41, "max": 1.0}, {"name": "conventions", "score": 0.71, "max": 1.0}, {"name": "evidence", "score": 0.36, "max": 1.0}, {"name": "restraint", "score": 0.59, "max": 1.0}]},
            {"n": 5, "tokens": 238_500, "verdict": "fail", "ungradedCode": None, "grades": [{"name": "correctness", "score": 0.58, "max": 1.0}, {"name": "integration", "score": 0.47, "max": 1.0}, {"name": "conventions", "score": 0.74, "max": 1.0}, {"name": "evidence", "score": 0.42, "max": 1.0}, {"name": "restraint", "score": 0.63, "max": 1.0}], "axes": [{"name": "correctness", "score": 0.58, "max": 1.0}, {"name": "integration", "score": 0.47, "max": 1.0}, {"name": "conventions", "score": 0.74, "max": 1.0}, {"name": "evidence", "score": 0.42, "max": 1.0}, {"name": "restraint", "score": 0.63, "max": 1.0}]},
            {"n": 6, "tokens": 274_300, "verdict": "fail", "ungradedCode": None, "grades": [{"name": "correctness", "score": 0.63, "max": 1.0}, {"name": "integration", "score": 0.52, "max": 1.0}, {"name": "conventions", "score": 0.79, "max": 1.0}, {"name": "evidence", "score": 0.47, "max": 1.0}, {"name": "restraint", "score": 0.70, "max": 1.0}], "axes": [{"name": "correctness", "score": 0.63, "max": 1.0}, {"name": "integration", "score": 0.52, "max": 1.0}, {"name": "conventions", "score": 0.79, "max": 1.0}, {"name": "evidence", "score": 0.47, "max": 1.0}, {"name": "restraint", "score": 0.70, "max": 1.0}]},
            {"n": 7, "tokens": 318_700, "verdict": "fail", "ungradedCode": None, "grades": [{"name": "correctness", "score": 0.70, "max": 1.0}, {"name": "integration", "score": 0.61, "max": 1.0}, {"name": "conventions", "score": 0.83, "max": 1.0}, {"name": "evidence", "score": 0.51, "max": 1.0}, {"name": "restraint", "score": 0.76, "max": 1.0}], "axes": [{"name": "correctness", "score": 0.70, "max": 1.0}, {"name": "integration", "score": 0.61, "max": 1.0}, {"name": "conventions", "score": 0.83, "max": 1.0}, {"name": "evidence", "score": 0.51, "max": 1.0}, {"name": "restraint", "score": 0.76, "max": 1.0}]},
            {"n": 8, "tokens": 366_200, "verdict": "fail", "ungradedCode": None, "grades": [{"name": "correctness", "score": 0.76, "max": 1.0}, {"name": "integration", "score": 0.68, "max": 1.0}, {"name": "conventions", "score": 0.87, "max": 1.0}, {"name": "evidence", "score": 0.57, "max": 1.0}, {"name": "restraint", "score": 0.81, "max": 1.0}], "axes": [{"name": "correctness", "score": 0.76, "max": 1.0}, {"name": "integration", "score": 0.68, "max": 1.0}, {"name": "conventions", "score": 0.87, "max": 1.0}, {"name": "evidence", "score": 0.57, "max": 1.0}, {"name": "restraint", "score": 0.81, "max": 1.0}]},
            {"n": 9, "tokens": 401_900, "mode": "evaluation", "verdict": "pass", "ungradedCode": None, "grades": [{"name": "correctness", "score": 0.82, "max": 1.0}, {"name": "integration", "score": 0.74, "max": 1.0}, {"name": "conventions", "score": 0.91, "max": 1.0}, {"name": "evidence", "score": 0.63, "max": 1.0}, {"name": "restraint", "score": 0.88, "max": 1.0}], "axes": [{"name": "correctness", "score": 0.82, "max": 1.0}, {"name": "integration", "score": 0.74, "max": 1.0}, {"name": "conventions", "score": 0.91, "max": 1.0}, {"name": "evidence", "score": 0.63, "max": 1.0}, {"name": "restraint", "score": 0.88, "max": 1.0}]},
        ],
    ...
    "exam-0061": {
        ...
        "attempts": [
            {"n": 1, "tokens": 74_200, "verdict": "fail", "ungradedCode": None, "grades": [{"name": "correctness", "score": 0.28, "max": 1.0}, {"name": "integration", "score": 0.20, "max": 1.0}, {"name": "conventions", "score": 0.51, "max": 1.0}, {"name": "evidence", "score": 0.15, "max": 1.0}, {"name": "restraint", "score": 0.44, "max": 1.0}], "axes": [{"name": "correctness", "score": 0.28, "max": 1.0}, {"name": "integration", "score": 0.20, "max": 1.0}, {"name": "conventions", "score": 0.51, "max": 1.0}, {"name": "evidence", "score": 0.15, "max": 1.0}, {"name": "restraint", "score": 0.44, "max": 1.0}]},
            {"n": 2, "tokens": 96_800, "verdict": "fail", "ungradedCode": None, "grades": [{"name": "correctness", "score": 0.35, "max": 1.0}, {"name": "integration", "score": 0.29, "max": 1.0}, {"name": "conventions", "score": 0.58, "max": 1.0}, {"name": "evidence", "score": 0.22, "max": 1.0}, {"name": "restraint", "score": 0.51, "max": 1.0}], "axes": [{"name": "correctness", "score": 0.35, "max": 1.0}, {"name": "integration", "score": 0.29, "max": 1.0}, {"name": "conventions", "score": 0.58, "max": 1.0}, {"name": "evidence", "score": 0.22, "max": 1.0}, {"name": "restraint", "score": 0.51, "max": 1.0}]},
            {"n": 3, "tokens": 121_500, "verdict": "fail", "ungradedCode": None, "grades": [{"name": "correctness", "score": 0.47, "max": 1.0}, {"name": "integration", "score": 0.38, "max": 1.0}, {"name": "conventions", "score": 0.65, "max": 1.0}, {"name": "evidence", "score": 0.31, "max": 1.0}, {"name": "restraint", "score": 0.60, "max": 1.0}], "axes": [{"name": "correctness", "score": 0.47, "max": 1.0}, {"name": "integration", "score": 0.38, "max": 1.0}, {"name": "conventions", "score": 0.65, "max": 1.0}, {"name": "evidence", "score": 0.31, "max": 1.0}, {"name": "restraint", "score": 0.60, "max": 1.0}]},
            {"n": 4, "tokens": 149_300, "verdict": "fail", "ungradedCode": None, "grades": [{"name": "correctness", "score": 0.55, "max": 1.0}, {"name": "integration", "score": 0.48, "max": 1.0}, {"name": "conventions", "score": 0.72, "max": 1.0}, {"name": "evidence", "score": 0.39, "max": 1.0}, {"name": "restraint", "score": 0.66, "max": 1.0}], "axes": [{"name": "correctness", "score": 0.55, "max": 1.0}, {"name": "integration", "score": 0.48, "max": 1.0}, {"name": "conventions", "score": 0.72, "max": 1.0}, {"name": "evidence", "score": 0.39, "max": 1.0}, {"name": "restraint", "score": 0.66, "max": 1.0}]},
        ],
